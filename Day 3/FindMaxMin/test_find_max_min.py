...
class TestFindMaxMin(unittest.TestCase):
    ...
    # Test if the function returns the number of elements in the list in a new list if the 'min' and 'max' are equal
